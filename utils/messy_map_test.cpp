...
int main(int, const char**)
{
	...
	ft::map<Key,T>::reverse_iterator rev = map.rbegin();
	ft::map<Key,T>::reverse_iterator crev = map.rbegin();
	++rev; rev++; rev++;
	++crev; crev++; crev++;
	std::cout << *rev << "\n";
	std::cout << *crev << "\n";
	rev = map.rend(); --rev; rev--; rev--; rev--; rev--;
	crev = map.rend(); --crev; crev--; crev--; crev--; crev--;
	std::cout << *rev << "\n";
	std::cout << *crev << "\n";
